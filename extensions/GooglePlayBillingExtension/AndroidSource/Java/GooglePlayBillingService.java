...
{	
	...
	public void acknowledgePurchase(final String _productId)
	{
		RunnerActivity.CurrentActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ...
                m_billingClient.acknowledgePurchase(params, 
                        new AcknowledgePurchaseResponseListener() {
                            ...
                            public void onAcknowledgePurchaseResponse(BillingResult responseCode) {
								...
								String json;
								json = "{ \"responseCode\" : " + Integer.toString(responseCode.getResponseCode()) + " }";								
	...
	public void consumeProduct(final String _productId)
	{
		RunnerActivity.CurrentActivity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ...
                ConsumeParams params = ConsumeParams.newBuilder()
                        .setPurchaseToken(_productId)
                        .build();
                m_billingClient.consumeAsync(params, 
                        new ConsumeResponseListener() {
                            ...
                            public void onConsumeResponse(BillingResult responseCode, String purchaseToken) {
								...
								if (responseCode.getResponseCode() == BillingClient.BillingResponseCode.OK) {
									...
									json = "{ \"success\":false, \"responseCode\" : " + Integer.toString(responseCode.getResponseCode()) + " }";
								}
