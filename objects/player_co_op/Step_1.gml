...
global.knocked_out_co_op = global.knocked_out

	if cannot_move = 0 && spin = 0
	{
...
buffer_write(chat_buffer, buffer_u8, DATA.P2_STATE);
...
buffer_write(chat_buffer, buffer_string, global.knocked_out_co_op);
