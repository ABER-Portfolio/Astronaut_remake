...
{
draw_text_kl_scale(x-(obj_camera.v_x/1280)*313,y-(obj_camera.v_y/720)*34,"Island size",50,-1,text_alpha,c_white,1,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*20,(text_scale/shape_scale)*camera_ysize*0.0125*20,0)
}
if global.language = 1
{
draw_text_kl_scale(x-(obj_camera.v_x/1280)*313,y-(obj_camera.v_y/720)*34,"섬 크기",50,-1,text_alpha,c_white,1,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*20,(text_scale/shape_scale)*camera_ysize*0.0125*20,0)
}
