...
image_yscale = 0.4
sprite_index = choose(pl_move_radiation_hazmat,pl_move_poison_hazmat,pl_move_cold_hazmat,pl_move_fire_hazmat,pl_move_projectile_hazmat)
sp_dilay = 0
...
random_bow = choose(71,67,67,66,66,68)
