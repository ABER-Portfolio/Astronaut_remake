...
{
draw_text_kl_scale(xx+(obj_camera.v_x/1280)*870,yy+(obj_camera.v_y/720)*first_text_space+(setting_num*text_space),"View size",(text_scale/shape_scale)*camera_ysize*0.0125*50*230,-1,text_alpha,c_white,0,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*30,(text_scale/shape_scale)*camera_ysize*0.0125*30,0)
}
if global.language = 1
{
draw_text_kl_scale(xx+(obj_camera.v_x/1280)*870,yy+(obj_camera.v_y/720)*first_text_space+(setting_num*text_space),"뷰 사이즈",(text_scale/shape_scale)*camera_ysize*0.0125*50*230,-1,text_alpha,c_white,0,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*30,(text_scale/shape_scale)*camera_ysize*0.0125*30,0)
}
global.sight = pressed/(200*1.8)
