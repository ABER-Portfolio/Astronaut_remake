...
/// @description Insert description here
// You can write your code in this editor
if(co_op_code.is_server == false) && player_co_op.spin = 0 && global.stemina > 0
{
	if ready_to_throw = 0 && global.inv_open = 0
	{
		...
		{
		global.swing = 2
		global.swing_co_op = 2
		}
		else
		{
		global.swing = 1
		global.swing_co_op = 1
		}
		cool_time = 1
		...
		if global.inhand_item != 14
		{
			if gun_kind = 1
			{
				...
				_bullet_.image_xscale = image_xscale
				_bullet_.image_yscale = image_yscale
