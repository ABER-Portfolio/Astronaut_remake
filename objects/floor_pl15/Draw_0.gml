...
if instance_number(BG_blind) = 0
{
	...
	{
	draw_sprite_ext(sprite171,0,x,y-32,-image_xscale,image_yscale,0,c_white,image_alpha)
	}
	...
	if !_top_m && _left_m && _right_m
	{
	draw_sprite_ext(sprite171,1,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
	
	if !_top_m && !_left_m && !_right_m
	{
	draw_sprite_ext(sprite171,2,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
