...
draw_sprite_ext(pl_shadow,image_index,floor(x),floor(y)-21*image_yscale,image_xscale*2,image_yscale*2,0,c_white,0.3)
...
{
draw_sprite_ext(inside_item,inside_item_index,floor(x),floor(y)+4,image_xscale*0.7,image_yscale*0.7,inside_item_angle,image_blend,image_alpha*0.43)
}
