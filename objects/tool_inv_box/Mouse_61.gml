...
if box_num = 1 && global.knocked_out = 0 && global.do_not_move = 0 && instance_number(pl_inhand) > 0 && global.inv_open = 0 && obj_camera.scene_cancle_cooltime > 2
{
	...
	audio_sound_gain(sf_ef,global.master_volume*global.sfx_volume*global.scene_volume*0.2,0)
		if global.tool_inv_box_choose >= 10
		{
