...
if instance_number(BG_blind) = 0
{
	...
	{
	draw_sprite_ext(sprite1711,12,x,y-32,-image_xscale,image_yscale,0,c_white,image_alpha)
	}
	...
	if !_top_m && _left_m && _right_m
	{
	draw_sprite_ext(sprite1711,13,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
	
	if !_top_m && !_left_m && !_right_m
	{
	draw_sprite_ext(sprite1711,14,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
