...
//draw_text(x,y-64,global.real_inventory_size)
...
if global.knocked_out_origin = 0
{
	...
	var _c_ = string(global.shirt_run_col_co_op)
		...
		{
		draw_sprite_ext(sprite_index,co_op_mode_spin,floor(x),floor(y),image_xscale*0.4,image_yscale*0.4,image_angle,((_a_)),image_alpha)
...
//draw_text(x,y,string(global.do_not_move2)+" / "+string(global.do_not_move)+" / "+string(cannot_move)+" / "+string(move_released)+" / "+string(global.movement_speed)+" / "+string(global.t_movement_speed))