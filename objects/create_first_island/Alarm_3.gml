...
random_value3 = round(irandom_range(-(20+gl_is_size),0))
random_value4 = round(irandom_range(0,(20+gl_is_size)))
xx = random_value3

random_value1 = round(irandom_range(-(20+gl_is_size),0))
random_value2 = round(irandom_range(0,(20+gl_is_size)))
yy = random_value1
