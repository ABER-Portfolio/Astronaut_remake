...
{
draw_text_kl_scale(xx+(obj_camera.v_x/1280)*870,yy+(obj_camera.v_y/720)*first_text_space+(setting_num*text_space),"Snow effect distance \n(Higher gives a softer effect)",(text_scale/shape_scale)*camera_ysize*0.0125*50*230,-1,text_alpha,c_white,0,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*30,(text_scale/shape_scale)*camera_ysize*0.0125*30,0)
}
if global.language = 1
{
draw_text_kl_scale(xx+(obj_camera.v_x/1280)*870,yy+(obj_camera.v_y/720)*first_text_space+(setting_num*text_space),"눈 이펙트 거리 \n(높을수록 부드러운 효과를 제공합니다)",(text_scale/shape_scale)*camera_ysize*0.0125*50*230,-1,text_alpha,c_white,0,-1,ko_80,(text_scale/shape_scale)*camera_xsize*0.0125*30,(text_scale/shape_scale)*camera_ysize*0.0125*30,0)
}
global.snow_effect_distance = pressed/(200*1.8)
