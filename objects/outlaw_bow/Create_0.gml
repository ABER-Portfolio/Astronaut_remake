...
hp_t = 0
w_alpha = 1
sprite_index = choose(pl_move,pl_move_builder,pl_move_s_mask,pl_move_s_mask1)
...
random_bow = choose(77,77,77,78,79,80,77,78,79,80,81,82,82,82,83,83,84,84,85,86)
arrow_type = choose(62,62,62,62,63,63,63,63,64,64,65,65,66,66,67)


if co_op_code.is_server = true
{
hp = random_bow/1.76
max_hp = random_bow/1.76
