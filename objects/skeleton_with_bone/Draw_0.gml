...
{
draw_sprite_ext(spr_pickaxe,76,floor(x)-((image_xscale)/abs(image_xscale))*5,floor(y)+7,-(image_xscale/abs(image_xscale))*0.3,0.3,weapon_angle,image_blend,image_alpha)
}
else
{
draw_sprite_ext(spr_pickaxe,76,floor(x)-((image_xscale)/abs(image_xscale))*5,floor(y)+9,-(image_xscale/abs(image_xscale))*0.3,0.3,weapon_angle,image_blend,image_alpha)
}
