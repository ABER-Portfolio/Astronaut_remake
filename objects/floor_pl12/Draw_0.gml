...
if instance_number(BG_blind) = 0
{
	...
	{
	draw_sprite_ext(sprite1711,6,x,y-32,-image_xscale,image_yscale,0,c_white,image_alpha)
	}
	...
	if !_top_m && _left_m && _right_m
	{
	draw_sprite_ext(sprite1711,7,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
	
	if !_top_m && !_left_m && !_right_m
	{
	draw_sprite_ext(sprite1711,8,x,y-32,image_xscale,image_yscale,0,c_white,image_alpha)
	}
