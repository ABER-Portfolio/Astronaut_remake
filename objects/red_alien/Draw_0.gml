...
if found_human = 1 && bullet_shoot_count > 0
{
	...
	{
	draw_sprite_ext(spr_pickaxe,72,floor(x),floor(y)+7,-0.3,gun_yscale,t_weapon_angle,image_blend,image_alpha)
	}
	else
	{
	draw_sprite_ext(spr_pickaxe,72,floor(x),floor(y)+9,-0.3,gun_yscale,t_weapon_angle,image_blend,image_alpha)
	}
}
