...
with (global.inventory_id)
{
    ...
    point_x -= ui_inv.inventory_draw_x;
    point_y -= ui_inv.inventory_draw_y;
...
//최종 인덱스 계산
var index = width_index + (height_index * (global.inventory_id).inventory_width);
return index;
