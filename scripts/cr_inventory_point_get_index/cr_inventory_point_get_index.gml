...
/// @param 인벤토리밖이거나 아이템 선택중이 아니면 -1반환
///@args point_x x좌표
///@args point_y y좌표
...
with (global.inventory_id)
{
    ...
    point_x -= ui_inv.cr_inventory_draw_x;
    point_y -= ui_inv.cr_inventory_draw_y;
...
//최종 인덱스 계산
var index = width_index + (height_index * (global.inventory_id).cr_inventory_width);
return index;
